...
Get_analysis_data = function(csv_path, binary_vars, full, single_layer_stratification, 
                             outcome_label='ic50.geometric.mean.imputed', censoring_label='ic50.censored',
                             strata_var_1 = 'subtype.reduced', strata_val_1,
                             strata_var_2 = 'geographic.region.of.origin', strata_val_2, 
  ...
  if (full) {
    ...
    } else { data_in = data_in[(data_in[strata_var_1]==strata_val_1) & (data_in[strata_var_2]==strata_val_2), ] }
  }  
  ...
  return( list(X = round(X, num_digits), delta = delta, U0 = data.matrix(U0), U = U, U_names = U_names, n_p_track = n_p_track) )
}
